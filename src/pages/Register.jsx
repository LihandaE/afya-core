...
export default function Register() {
  ...
  if (!licenceRegex.test(form.ppbLicence)) {
  setMessage({
  type: "error",
  text:
  "PPB Licence must be at least 5 characters long and contain at least one uppercase letter.",
  });
  return;
  }
...
/>
<input
placeholder="PPB Licence (min 5 chars, 1 uppercase)"
className="border p-3 w-full mb-3"
value={form.ppbLicence}
onChange={(e) =>
